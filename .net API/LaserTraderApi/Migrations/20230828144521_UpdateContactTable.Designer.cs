...
namespace LaserTraderApi.Migrations
{
    ...
    [Migration("20230828144521_UpdateContactTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LaserTraderApi.Models.Offer", b =>
                {
            ...
            modelBuilder.Entity("LaserTraderApi.Models.Warranty", b =>
                {
                    ...
                    b.Property<string>("LastServiceAction")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.Property<string>("PreferredContactMode")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.Property<string>("RecentServiceUserName")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<string>("UnderWarrantyUserName")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
                    ...
                    b.Property<string>("WarrantyPlanCost")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.Property<string>("WarrantyPlanPeriod")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");
            ...
            modelBuilder.Entity("LaserTraderApi.Models.WatchList", b =>
                {
            ...
            modelBuilder.Entity("LaserTraderApi.Models.WatchListProduct", b =>
                {
                    b.Property<int>("WatchListProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("WatchListProductId"));
                    ...
                    b.HasKey("WatchListProductId");

                    b.HasIndex("ProductId");

                    b.HasIndex("WatchListId");

                    b.ToTable("WatchListProducts");
                });

            modelBuilder.Entity("LaserTraderApi.Models.WatchListProductOption", b =>
                {
                    b.Property<int>("WatchListProductOptionId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("WatchListProductOptionId"));
                    ...
                    b.HasKey("WatchListProductOptionId");

                    b.HasIndex("ProductOptionId");

                    b.HasIndex("WatchListId");

                    b.ToTable("WatchListProductOptions");
                });

            modelBuilder.Entity("LaserTraderApi.Models.Offer", b =>
                {
                    b.HasOne("LaserTraderApi.Models.Contact", "Contact")
                        .WithMany()
                        .HasForeignKey("ContactId");

                    b.HasOne("LaserTraderApi.Models.Inventory", "Inventory")
                        .WithMany()
            ...
            modelBuilder.Entity("LaserTraderApi.Models.WatchListProduct", b =>
                {
                    b.HasOne("LaserTraderApi.Models.Product", "Product")
                        .WithMany()
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LaserTraderApi.Models.WatchList", null)
            ...
            modelBuilder.Entity("LaserTraderApi.Models.WatchListProductOption", b =>
                {
                    b.HasOne("LaserTraderApi.Models.ProductOption", "ProductOption")
                        .WithMany()
                    ...
                    b.HasOne("LaserTraderApi.Models.WatchList", null)
                        .WithMany("WatchListProductOptions")
                        .HasForeignKey("WatchListId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("LaserTraderApi.Models.WatchList", b =>
                {
                    b.Navigation("WatchListProductOptions");
