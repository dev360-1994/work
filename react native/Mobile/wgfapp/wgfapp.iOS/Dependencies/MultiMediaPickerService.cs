...
namespace wgfapp.iOS.Dependencies
{
    public class MultiMediaPickerService : IMultiMediaPickerService
    {
        ...
        private static TaskCompletionSource<IList<MediaFile>> mediaPickTcs;
            ...
            for (var i = 0; i < args.Assets.Length; i++)
            {
                ...
                switch (asset.MediaType)
                {
                    case PHAssetMediaType.Video:
                        ...
                        PHImageManager.DefaultManager.RequestImageForAsset(asset, new System.Drawing.SizeF(150.0f, 150.0f),
