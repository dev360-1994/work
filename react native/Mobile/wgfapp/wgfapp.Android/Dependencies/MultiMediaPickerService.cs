...
namespace wgfapp.Droid.Dependencies
{
    ...
    {
        private int MultiPickerResultCode = 9793;
        private const string TemporalDirectoryName = "TmpMedia";
        private static TaskCompletionSource<IList<MediaFile>> mediaPickedTcs;
        ...
        MediaFile CreateMediaFileFromUri(Uri uri)
        {
