...
namespace wgfapp
{
    public partial class App : Application
    {
        ...
        private static IPersistanceService _persistanceService;
        ...
        {
            string selectedColorHex = _persistanceService.SelectedColor;
            if (!string.IsNullOrEmpty(selectedColorHex))
                App.Current.Resources["NavigationBarColor"] = selectedColorHex;
        }
    }
}
