...
namespace wgfapp.Services
{
    public class PersistanceService : IPersistanceService
    {
        ...
        private const string SelectedColorKey = "SelectedColor";
        ...
        {
            get => SecureStorage.GetSecuredValue(SelectedColorKey);
            set => SecureStorage.SetSecuredValue(SelectedColorKey, value);
        }
