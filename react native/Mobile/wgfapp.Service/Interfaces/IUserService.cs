...
namespace wgfapp.Service.Interfaces
{
    public interface IUserService
    {
        ...
        Task<Team> GetTeamInfo(int teamId, int userId, string token, CancellationToken cancellationToken = default(CancellationToken));
        Task<DashboardAlerts> GetDashboardAlertsStatus(int teamId, int userId, string token, CancellationToken cancellationToken = default(CancellationToken));
    }
}
