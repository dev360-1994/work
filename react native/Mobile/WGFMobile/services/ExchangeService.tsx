...
export const exchangeTeamEmail = (teamId: any) => get(`${BASE_URL}/api/TeamUsers/ExchangeTeamEmail/${teamId}`, null);

export const sendLeagueTeamEmail = (params: any) => post(`${BASE_URL}/api/Exchange/SendLeagueTeamEmail`, params);
