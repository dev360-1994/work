...
export default function OtherPlaylistScreen({ navigation }: RootDrawerScreenProps<'ViewPlaylist'>) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            {(isSubmitting) ? (
                ...
                <PlaylistComponent typeCode={'O'} typeName={'Other'} sessionData={sessionData ?? undefined} />
            )}
