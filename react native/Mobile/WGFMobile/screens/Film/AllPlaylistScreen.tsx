...
export default function AllPlaylistScreen({ navigation }: RootDrawerScreenProps<'ViewPlaylist'>) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            {(isSubmitting) ? (
                ...
                <PlaylistComponent typeCode={'A'} typeName={'All'} sessionData={sessionData ?? undefined} />
            )}
