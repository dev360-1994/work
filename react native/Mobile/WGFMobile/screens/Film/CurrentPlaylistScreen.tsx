...
export default function CurrentPlaylistScreen({ navigation }: RootDrawerScreenProps<'ViewPlaylist'>) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            {(isSubmitting) ? (
                ...
                <PlaylistComponent typeCode={'S'} typeName={'Current'} sessionData={sessionData ?? undefined} />
            )}
