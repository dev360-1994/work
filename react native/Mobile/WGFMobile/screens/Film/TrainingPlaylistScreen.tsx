...
export default function TrainingPlaylistScreen({ navigation }: RootDrawerScreenProps<'ViewPlaylist'>) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            {(isSubmitting) ? (
                ...
                <PlaylistComponent typeCode={'T'} typeName={'Training'} sessionData={sessionData ?? undefined} />
            )}
