...
import { exchangeGridData, exchangeLeaguePostData } from "../../../services/ExchangeService";
import { ExchangeLeague, ExchangeModel } from "../../../services/Model/ExchangeModel";
import { MessageModel } from "../../../services/Model/MessageModel";
import { SessionInfoModel } from "../../../services/Model/SessionInfoModel";

export const CheckInComponent = ({ sessionData }: { sessionData?: SessionInfoModel }) => {
    const [searchPlaceHolder, setSearchPlaceHolder] = useState("Locker In");
    ...
    const onPressViewFilmHandler = async (item: ExchangeModel) => {
        var playlistInfo: ExchangeLeague = await exchangeLeaguePostData(item.playlistguid);
        navigation.navigate('CheckInForm', {
            playlistInfo: playlistInfo, playlistGuid: item.playlistguid
        });
    };
