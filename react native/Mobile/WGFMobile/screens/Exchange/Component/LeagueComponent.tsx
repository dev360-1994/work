...
export const LeagueComponent = ({ sessionData }: { sessionData?: SessionInfoModel }) => {
    const [searchPlaceHolder, setSearchPlaceHolder] = useState("League Exchange");
    ...
    const onPressViewFilmHandler = async (item: ExchangeModel) => {
        ...
        navigation.navigate('LeagueForm', {
            title: result.playlistname, date: result.playlistdate, filmGuid: item.playlistguid, clips: result.clips
        });
    };
