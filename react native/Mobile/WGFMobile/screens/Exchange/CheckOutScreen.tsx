...
export default function CheckOutScreen({ navigation }: RootDrawerScreenProps<'LockerOut'>) {
            ...
            headerRight: () => (
                <Pressable onPress={openMenu}
                    ...
                    <Menu
                        ...
                        <Menu.Item onPress={() => { closeMenu(); navigation.navigate("ContactLeagueTeam"); }} title={"Contact"} />
                    </Menu>
                </Pressable>
            ),
            headerShown: true,
    ...
    return (
        <SafeAreaView style={styles.container}>
            {(isSubmitting) ? (
                ...
                <CheckOutComponent sessionData={sessionData ?? undefined} />
            )}
