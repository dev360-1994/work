...
export default function TeamDetailsScreen({ navigation }: RootDrawerScreenProps<'TeamDetails'>) {
    ...
    const colorChangeHandler = (teamColor: any) => {
        let data = {
            "TeamId": teamUserInfo?.teamId,
            "TeamColor": teamColor
        }
        console.log(data);
        // OnGetUpdateTeamColor(data);
    }
                ...
                <Dialog visible={visible} onDismiss={hideDialog}>
                    ...
                    <Dialog.Content>
                        <View style={{ paddingHorizontal: "30%" }}>
                            ...
                            <TouchableOpacity onPress={() => colorChangeHandler("#224A8D")} style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={40} color={"#224A8D"} /><Text style={{ textAlignVertical: "center", fontSize: 20 }}>Cyan</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => colorChangeHandler("#0D87B8")} style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={40} color={"#0D87B8"} /><Text style={{ textAlignVertical: "center", fontSize: 20 }}>Green</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => colorChangeHandler("#239D59")} style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={40} color={"#239D59"} /><Text style={{ textAlignVertical: "center", fontSize: 20 }}>Orange</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => colorChangeHandler("#C84B2B")} style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={40} color={"#C84B2B"} /><Text style={{ textAlignVertical: "center", fontSize: 20 }}>Red</Text>
                            </TouchableOpacity>
                        </View>
