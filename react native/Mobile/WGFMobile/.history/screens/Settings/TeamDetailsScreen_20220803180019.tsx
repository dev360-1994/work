                ...
                <Dialog visible={visible} onDismiss={hideDialog}>
                    ...
                    <Dialog.Content>
                        <View style={{ paddingHorizontal: "30%" }}>
                            <TouchableOpacity onPress={() => { colorChangeHandler("#000000"); closeMenu(); }} style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={40} color={"#000000"} /><Text style={{ textAlignVertical: "center", fontSize: 20 }}>Black</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => { colorChangeHandler("#6330CC"); closeMenu(); }} style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={40} color={"#6330CC"} /><Text style={{ textAlignVertical: "center", fontSize: 20 }}>Purple</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => { colorChangeHandler("#432475"); closeMenu(); }} style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={40} color={"#432475"} /><Text style={{ textAlignVertical: "center", fontSize: 20 }}>Indigo</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => { colorChangeHandler("#224A8D"); closeMenu(); }} style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={40} color={"#224A8D"} /><Text style={{ textAlignVertical: "center", fontSize: 20 }}>Blue</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => { colorChangeHandler("#0D87B8"); closeMenu(); }} style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={40} color={"#0D87B8"} /><Text style={{ textAlignVertical: "center", fontSize: 20 }}>Cyan</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => { colorChangeHandler("#239D59"); closeMenu(); }} style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={40} color={"#239D59"} /><Text style={{ textAlignVertical: "center", fontSize: 20 }}>Green</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => { colorChangeHandler("#C84B2B"); closeMenu(); }} style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={40} color={"#C84B2B"} /><Text style={{ textAlignVertical: "center", fontSize: 20 }}>Orange</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => { colorChangeHandler("#C3233D"); closeMenu(); }} style={{ flexDirection: "row", justifyContent: "space-between" }}>
