        ...
        <SafeAreaView>
            ...
            <Portal>
                <Dialog visible={isSeasonStartsPopupVisible} onDismiss={hideSeasonDialog}>
                    <Dialog.Title style={{ textAlign: "center", fontSize: 20 }} >Select Month Season Starts: {sessionStartMonth}</Dialog.Title>
                    <Dialog.Content>
                        <View style={{ paddingHorizontal: "30%" }}>
                            <TouchableOpacity onPress={() => colorChangeHandler("#000000")} style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <Text style={{ textAlignVertical: "center", fontSize: 20 }}>January</Text>
                            </TouchableOpacity>
                        </View>
                    </Dialog.Content>
                    <Dialog.Actions>
