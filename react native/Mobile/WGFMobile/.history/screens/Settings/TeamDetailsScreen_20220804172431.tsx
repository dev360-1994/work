...
export default function TeamDetailsScreen({ navigation }: RootDrawerScreenProps<'TeamDetails'>) {
    ...
    const seasonUpdateToast = useToast();
            ...
            headerRight: () => (
                <Pressable onPress={openMenu}
                    ...
                    <Menu
                        ...
                        <Menu.Item onPress={() => { closeMenu(); console.log(value); showSeasonDialog(); }} title={
                            <Button
                                // color="#000"
    ...
    function seasonUpdatedSuccessAlert() {
        return <Box bg="emerald.500" px="2" backgroundColor={"green"} py="1" rounded="sm" mb={5}>
            Season start month saved successfully
        </Box>;
    }
