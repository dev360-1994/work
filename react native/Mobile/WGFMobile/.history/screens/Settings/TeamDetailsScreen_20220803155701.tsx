            ...
            headerRight: () => (
                <Pressable onPress={() => { openMenu(); console.log("pressed") }}
                    ...
                    <Menu
                        ...
                        <Menu.Item onPress={() => { closeMenu() }} title={`Team Color: ${<Feather name="settings" size={22} color={teamUserInfo?.teamColor} />}`} />
                    </Menu>
                </Pressable>
            ),
        })
        ...
        <SafeAreaView>
            ...
            <View style={styles.container}>
                <View style={styles.rowContainer}>
                    ...
                    <Feather name="settings" size={22} color={teamUserInfo?.teamColor} />
                    <TextInput
                        editable={false}
