            ...
            <Portal>
                <Dialog visible={visible} onDismiss={hideDialog}>
                    ...
                    <Dialog.Content>
                        ...
                        <FontAwesome name="circle" size={50} color={"#6330CC"} />
                        <FontAwesome name="circle" size={50} color={"#432475"} />
                        <FontAwesome name="circle" size={50} color={"#224A8D"} />
                        <FontAwesome name="circle" size={50} color={"#0D87B8"} />
                        <FontAwesome name="circle" size={50} color={"#239D59"} />
                        <FontAwesome name="circle" size={50} color={"#C84B2B"} />
                        <FontAwesome name="circle" size={50} color={"#C3233D"} />
