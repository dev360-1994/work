...
import HistoryComponent from "../Film/Component/HistoryComponent";
...
export default function HistoryScreen({ navigation }: RootDrawerScreenProps<'ViewPlaylist'>) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            {(isSubmitting) ? (
                ...
                <HistoryComponent typeCode={'R'} typeName={'History'} sessionData={sessionData ?? undefined} />
            )}
