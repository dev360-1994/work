                    ...
                    <Menu
                        ...
                        <Menu.Item onPress={() => { closeMenu(); showSeasonDialog(); }} title={
                            <View>
                                ...
                                >Season Starts: {sessionStartMonth}</Button>
                            </View>
                ...
                <Dialog visible={isSeasonStartsPopupVisible} onDismiss={hideSeasonDialog}>
                    ...
                    <Dialog.Content>
                        <View style={{ alignItems: "center" }}>
                            <TouchableOpacity onPressIn={sessionChangeHandler} style={{ paddingBottom: 10, }} onPress={() => { }} >
                                <Text style={{ fontSize: 20 }}>January</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => { }} style={{ paddingBottom: 10, }}  >
                                <Text style={{ fontSize: 20 }}>Februry</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => { }} style={{ paddingBottom: 10, }}  >
                            ...
                            <TouchableOpacity onPress={() => { }} style={{ paddingBottom: 10, }}  >
                                <Text style={{ fontSize: 20 }}>Augest</Text>
                            </TouchableOpacity>
                            <TouchableOpacity onPress={() => { }} style={{ paddingBottom: 10, }}  >
