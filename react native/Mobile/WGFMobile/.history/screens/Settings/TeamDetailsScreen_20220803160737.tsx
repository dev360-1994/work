                    ...
                    <Menu
                        ...
                        <Menu.Item onPress={() => { closeMenu() }} title={
                            <View style={{ flexDirection: "row" }}>
                                <Text style={{ borderWidth: 1, textAlignVertical: "center", fontSize: 15 }} >Team Color :</Text>
                                <FontAwesome style={{ paddingLeft: 20 }} name="circle" size={50} color={teamUserInfo?.teamColor} />
                            </View>} />
                    </Menu>
                </Pressable>
            ),
