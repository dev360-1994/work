            ...
            <Portal>
                <Dialog visible={visible} onDismiss={hideDialog}>
                    ...
                    <Dialog.Content>
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                            <FontAwesome name="circle" size={50} color={"#6330CC"} /><Text style={{ textAlignVertical: "center", fontSize: 30 }}>Black</Text>
                        </View>
                        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                            <FontAwesome name="circle" size={50} color={"#432475"} /><Text style={{ textAlignVertical: "center", fontSize: 30 }}>Black</Text>
                        </View>

                        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                            <FontAwesome name="circle" size={50} color={"#224A8D"} /><Text style={{ textAlignVertical: "center", fontSize: 30 }}>Black</Text>
                        </View>
                        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                            <FontAwesome name="circle" size={50} color={"#224A8D"} /><Text style={{ textAlignVertical: "center", fontSize: 30 }}>Black</Text>
                        </View>
                        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                            <FontAwesome name="circle" size={50} color={"#0D87B8"} /><Text style={{ textAlignVertical: "center", fontSize: 30 }}>Black</Text>
                        </View>

                        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                            <FontAwesome name="circle" size={50} color={"#239D59"} /><Text style={{ textAlignVertical: "center", fontSize: 30 }}>Black</Text>
                        </View>

                        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                            <FontAwesome name="circle" size={50} color={"#C84B2B"} /><Text style={{ textAlignVertical: "center", fontSize: 30 }}>Black</Text>
                        </View>

                        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                            <FontAwesome name="circle" size={50} color={"#C3233D"} /><Text style={{ textAlignVertical: "center", fontSize: 30 }}>Black</Text>
                        </View>
