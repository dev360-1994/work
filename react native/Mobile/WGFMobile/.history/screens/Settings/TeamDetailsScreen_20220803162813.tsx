            ...
            headerRight: () => (
                <Pressable onPress={() => { openMenu(); console.log("pressed") }}
                    ...
                    <Menu
                        ...
                        <Menu.Item onPress={() => { closeMenu(); }} title={`Month Season Starts: ${sessionStartMonth}`} />
                        <Menu.Item onPress={() => { closeMenu(); showDialog(); }} title={
                            <View style={{ flexDirection: "row", justifyContent: "space-between", backgroundColor: { teamUserInfo?.teamColor }}}>
                            <Text style={{ textAlignVertical: "center", fontSize: 15 }} >Team Color :  </Text>
                    ...
                    <Dialog.Content>
                        <View style={{ paddingHorizontal: "20%" }}>
                            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={50} color={"#000000"} /><Text style={{ textAlignVertical: "center", fontSize: 30 }}>Black</Text>
                            </View>
                            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={50} color={"#6330CC"} /><Text style={{ textAlignVertical: "center", fontSize: 30 }}>Purple</Text>
                            </View>
                            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={50} color={"#432475"} /><Text style={{ textAlignVertical: "center", fontSize: 30 }}>Indigo</Text>
                            </View>

                            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={50} color={"#224A8D"} /><Text style={{ textAlignVertical: "center", fontSize: 30 }}>Blue</Text>
                            </View>
                            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={50} color={"#224A8D"} /><Text style={{ textAlignVertical: "center", fontSize: 30 }}>Cyan</Text>
                            </View>
                            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={50} color={"#0D87B8"} /><Text style={{ textAlignVertical: "center", fontSize: 30 }}>Green</Text>
                            </View>

                            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={50} color={"#239D59"} /><Text style={{ textAlignVertical: "center", fontSize: 30 }}>Orange</Text>
                            </View>

                            <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                                <FontAwesome name="circle" size={50} color={"#C84B2B"} /><Text style={{ textAlignVertical: "center", fontSize: 30 }}>Red</Text>
                            </View>
                        </View>
