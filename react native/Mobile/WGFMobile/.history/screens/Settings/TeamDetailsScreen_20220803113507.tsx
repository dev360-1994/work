        ...
        <SafeAreaView>
            <View style={styles.container}>
                <View style={styles.rowContainer}>
                    <Text style={{ fontWeight: "bold", color: getTextColor(), flex: 1, flexDirection: "row", textAlign: "center", textAlignVertical: "center" justifyContent: "center", borderWidth: 1, }}>First Name</Text>
                    <TextInput
                        editable={false}
