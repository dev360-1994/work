        ...
        <View style={styles.centeredView}>
          ...
          >
            <View style={{ flex: 1 }}>
              ...
              >
                <Text style={{ flex: 1, color: "white", fontSize: 15, }} >Recording {recordingCount} of {recordingCount}</Text>
                <Text style={{ flex: 1, color: "white", fontSize: 15 }} >Uploading {recordingCount} of {recordingCount}</Text>
              </View>
