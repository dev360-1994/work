      ...
      <View style={{ flexGrow: 1 }}>
        <View style={styles.container}>
          ...
          <View style={{ marginTop: 20, flexDirection: "row", justifyContent: "space-between" }}>
            ...
            <Box w="3/4" maxW="300">
              <Select selectedValue={sound} minWidth="200" accessibilityLabel="Choose Service" placeholder="Choose Service" _selectedItem={{
                bg: "teal.600",
                endIcon: <CheckIcon size="5" />
              }} mt={1} onValueChange={itemValue => setSound(itemValue)}>
                <Select.Item label="Remove Audio" value="removeAudio" />
                <Select.Item label="Keep Audio" value="keepAudio" />
              </Select>
            </Box>
          </View>
