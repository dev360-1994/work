...
export default function ProfileScreen({ navigation }: RootDrawerScreenProps<'Profile'>) {
    ...
    const [teams, setTeams] = useState([
        { label: 'Both', value: 0 }, { label: 'Email', value: 1 }, { label: 'Sms Text', value: 2 }
    ]);
                            ...
                            <View style={styles.dropdownContainer}>
                                <View style={{ paddingBottom: 20 }}>
                                    ...
                                    <DropDownPicker style={styles.Dropdown}
                                        ...
                                        setItems={setTeams}
                                        multiple={false}
                                        containerStyle={{ margin: 10, width: '100%' }}
...
function onDropdownChangeHandler(status: string | null): void {
    console.log(status);
}
