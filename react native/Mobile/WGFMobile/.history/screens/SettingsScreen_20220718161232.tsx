            ...
            headerRight: () => (
                <Pressable
                    ...
                    <OptionsMenu
                        ...
                        />}
                        destructiveIndex={3}
                        options={["Leave Team", "Reset Password", "Save Profile", "Cancel"]}
                        actions={[showLeaveTeamConfirmDialog, () => setModalVisible(true), () => showSaveConfirmDialog()]} />
                    ...
                    <View style={{ flexGrow: 1 }}>
                        <View style={styles.container}>
                            ...
                            <View style={styles.buttonContainer}>
                                ...
                                <Pressable onPress={showSaveConfirmDialog}>
                                    <View style={[{ flex: 1, backgroundColor: "#28a745", height: 40, },]}>
                                        <Text style={{ color: "white", textAlign: "center", fontSize: 14, paddingTop: 5 }}  >Save</Text>
                                    </View>
                                </Pressable>
                            </View>
