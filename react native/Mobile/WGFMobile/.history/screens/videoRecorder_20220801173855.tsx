...
export default function VideoRecorderScreen({ navigation, route }: RootDrawerScreenProps<'VideoRecord'>) {
  ...
  useEffect(() => {
    setIsPreviousScreen(route.params?.prevScreen);
    console.log(isPreviousScreen);
    const { userContext } = preferencesContext();
    userTeamColor = userContext.userInfo.teamColor == undefined ? '#000000' : userContext.userInfo.teamColor;
  }, [isFocused, route, userTeamColor]);
          ...
          <View style={styles.container}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between" }} >
              ...
              <Pressable onPress={createFilmHandler}
                style={[styles.pressableButton, { backgroundColor: userTeamColor }]}>
