...
export default function VideoRecorderScreen({ navigation }: RootDrawerScreenProps<'VideoRecord'>) {
  ...
  const onPressDropdown = () => ActionSheetIOS.showActionSheetWithOptions(
    {
      options: ["Remove Audio", "Keep Audio", "cancel"],
            ...
            <View style={{ marginTop: 30, flexDirection: "row", justifyContent: "space-between" }}>
              ...
              <View style={styles.pickerContainer}>
                ...
                }
                {
                  isIOS &&
                  <Text
                    style={[styles.text, { color: "#cccccc", paddingLeft: 10, paddingTop: 12 }]}
                    onPress={onPressDropdown} >{sound}</Text>
                }
              </View>
            </View>
