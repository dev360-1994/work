...
export default function VideoRecorderScreen({ navigation }: RootDrawerScreenProps<'VideoRecord'>) {
  ...
  const createFilmHandler = () => {
    ...
    filmModal.Group = parseInt(type.toString());
    filmModal.Angle = parseInt(camera.toString());
    filmModal.Tags = tag;
    // console.log(filmModal);
    var result = createNewFilm(filmModal);
    //result data:
    //  PlayListId 
    //  FilmGuid 
              ...
              <View style={styles.pickerContainer}>
                {
                  ...
                  <Picker
                    ...
                    <Picker.Item label="Game" value="0" />
                    <Picker.Item label="Practice" value="1" />
                    <Picker.Item label="Scout" value="2" />
                    <Picker.Item label="Training" value="3" />
