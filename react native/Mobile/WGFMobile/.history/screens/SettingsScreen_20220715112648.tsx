...
import { StyleSheet, Text, View, Button, Pressable, TextInput, SafeAreaView, Alert, Modal, ScrollView, ToastAndroid } from 'react-native';
                        ...
                        <View style={styles.container}>
                            ...
                            <View style={styles.dropdownContainer}>
                                <View style={{ paddingBottom: 10 }}>
                                    ...
                                    <SelectDropdown
                                        defaultValueByIndex={preference}
                                        data={preferenceList}
                                ...
                                <View style={{}}>
                                    ...
                                    <View style={{ width: 20 }}>
                                        <SelectDropdown
                                            defaultValueByIndex={notification}
