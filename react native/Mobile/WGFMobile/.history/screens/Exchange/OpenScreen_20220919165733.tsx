...
import { OpenComponent } from "./Component/OpenComponent";
...
export default function OpenScreen({ navigation }: RootDrawerScreenProps<'OpenExchange'>) {
    ...
    return (
        <SafeAreaView style={styles.container}>
            {(isSubmitting) ? (
                ...
                <OpenComponent sessionData={sessionData ?? undefined} />
            )}
