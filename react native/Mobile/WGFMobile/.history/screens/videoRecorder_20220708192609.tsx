      ...
      <View>
        ...
        <View style={styles.container}>
          ...
          <View style={{ marginTop: 30, flexDirection: "row", justifyContent: "space-between" }}>
            ...
            <View style={{ borderWidth: 1, height: 50, width: 240, borderColor: "#8e8e8e" }}>
              ...
              <Picker
                ...
                <Picker.Item style={{ color: "#cccccc", fontSize: 18, }} value='' label='Select Film Type' />
          ...
          <View style={{ marginTop: 30, flexDirection: "row", justifyContent: "space-between" }}>
            ...
            <View style={{ borderWidth: 1, height: 50, width: 240, borderColor: "#8e8e8e" }}>
              <Picker
                ...
                mode="dropdown"
                itemStyle={{ color: 'red', fontWeight: '900', fontSize: 18, padding: 30 }}>
                <Picker.Item style={{ color: "#cccccc", fontSize: 18, }} value='' label='Select Camera Angle' />
