            ...
            headerRight: () => (
                <Pressable
                    ...
                    <OptionsMenu
                        ...
                        />}
                        destructiveIndex={0}
                        options={["Leave Team", "Reset Password", "Save", "Cancel"]}
                    ...
                    <View style={{ flexGrow: 1 }}>
                        <View style={styles.container}>
                            ...
                            {/* <View style={styles.buttonContainer}>
                                ...
                                <View style={{ padding: 5, width: Platform.OS == "android" ? 100 : 100 }}>
                                    <Button color={"#28a745"} title='Save' onPress={showSaveConfirmDialog} />
                                </View>
