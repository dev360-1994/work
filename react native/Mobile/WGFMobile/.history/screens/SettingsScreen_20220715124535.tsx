                                    ...
                                    <View style={styles.pickerContainer}>
                                        {
                                            ...
                                            <Picker
                                                ...
                                                onValueChange={d => setPreference(d)}
                                                style={styles.picker}
                                                mode="dropdown"
                                            >
                                        ...
                                        }
                                        {
                                            ...
                                            <Text
                                                ...
                                                onPress={() => onPressPreferenceDropdown(["Both", "Email", "Sms Text"],)} >{preference}
                                            </Text>
                                        }
                                    </View>
                                    ...
                                    <View style={styles.pickerContainer}>
                                        {
                                            ...
                                            <Picker
                                                ...
                                                onValueChange={(item, index) => { console.log(index) }}
                                                style={styles.picker}
                                                mode="dropdown"
                                            >
                                        ...
                                        }
                                        {
                                            ...
                                            <Text
                                                style={[styles.text, { paddingLeft: 10, paddingTop: 12, fontWeight: "400" }]}
                                                onPress={() => onPressDncDropdown(notificationList,)} >{dnc}
                                            </Text>
                                        }
                                    </View>
