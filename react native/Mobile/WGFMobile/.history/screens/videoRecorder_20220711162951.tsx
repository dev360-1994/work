...
export default function VideoRecorderScreen({ navigation }: RootDrawerScreenProps<'VideoRecord'>) {
  ...
  const onPressDropdown = (options: [""]) => ActionSheetIOS.showActionSheetWithOptions(
    {
      options: options,
            ...
            <View style={{ marginTop: 30, flexDirection: "row", justifyContent: "space-between" }}>
              ...
              <View style={styles.pickerContainer}>
                ...
                }
                {
                  isIOS &&
                  <Text
                    style={[styles.text, { paddingLeft: 10, paddingTop: 12, fontWeight: "100" }]}
                    onPress={() => onPressDropdown(["Remove Audio", "Keep Audio", "Cancel"],)} >{sound}</Text>
                }
              </View>
            </View>
