          ...
          <View style={styles.container}>
            <View style={{}}>
              ...
              <TextInput
                ...
                onChangeText={(v) => { setFilmTitle(v); setFilmTitleErrorMessage("") }}
            ...
            <View style={{ marginTop: "3%", }}>
              ...
              <>
                <DropDownPicker
                  ...
                  onChangeValue={(v) => setTypeErrorMessage("")}
