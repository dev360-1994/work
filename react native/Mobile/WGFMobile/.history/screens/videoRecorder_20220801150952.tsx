  ...
  const createFilmHandler = async () => {
    ...
    if (['UploadFromDevice', 'GoogleDriveUpload', 'TranferFromHudl'].includes(route.params?.prevScreen)) {
      ...
      if (previousScreen == 'UploadFromDevice') {
        ...
        await axios({
          method: 'post',
          url: "https://3769-103-99-202-239.in.ngrok.io/api/UploadFilm/GoogleDriveTransfer",
          data: data
        }).then((response) => {
        ...
        <ScrollView>
          <View style={styles.container}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between" }} >
              ...
              <Pressable disabled={createFilmDisabled} onPress={createFilmHandler}
                style={[styles.pressableButton, { backgroundColor: createFilmDisabled ? "#dddddd" : "#337ab7" }]}>
