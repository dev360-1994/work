...
import {
    ...
    BackHandler, useWindowDimensions, Dimensions
} from 'react-native';
...
export const VideoRecorderModal = (props) => {
    ...
    return (
        ...
        <View style={{ flex: 1, width: "100%", height: "100%" }}>
            ...
            <View style={[styles.headerConatiner, { backgroundColor: userTeamColor, opacity: getScreen().width > getScreen().height ? 0.2 : 1 }]}>
                <View style={[{ left: 10 }]}>
            ...
            <View style={[styles.titleText, { backgroundColor: userTeamColor, opacity: getScreen().width > getScreen().height ? 0.2 : 1 }]}>
