...
export default function VideoScreen({ route }: { route: any }) {
    ...
    const [filmGuild, setFilmGuid] = useState(null);
        ...
        headerRight: () => (
            <Pressable onPress={openMenu}
                ...
                <Menu
                    ...
                    <Menu.Item onPress={() => { closeMenu(); navigation.navigate("RecordGame") }} title={"Record More"} />
        ...
        try {
            ...
            if (clipList) {
                if (clipId <= 0) {
                    ...
                    console.log(clipList[clipIndex]?.filmGuid);
