...
import { Button, Text, Card, Divider, RadioButton } from "react-native-paper";
            ...
            <Card style={{ width: "100%" }}>
                ...
                <Card.Content>
                    <View style={styles.radioButtonContainer}>
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
                            <TextInput placeholder="Url..." style={{
                                borderWidth: 1, width: "100%", height: 50, paddingRight: 5, paddingLeft: 5, backgroundColor: getTextColor()
                            }}
                                onChangeText={setUrl}
                            />
                ...
                <Card.Actions>
                    <View style={{ flex: 1, flexDirection: "row", justifyContent: "space-between" }}>
                        ...
                        <Button mode="contained" style={{ width: 100 }} color="#337ab7" onPress={() => { validateCloudUrl(); }}>
