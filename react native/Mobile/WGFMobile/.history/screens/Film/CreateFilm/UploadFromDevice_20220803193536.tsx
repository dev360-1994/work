            ...
            <Card style={{ width: "80%" }}>
                ...
                <Card.Content>
                    <View style={styles.radioButtonContainer}>
                        ...
                        </Button>
                        {
                            ...
                            <View style={{ borderWidth: 0, marginTop: 20, borderColor: "#cccccc" }}>
                ...
                <Card.Actions>
                    <View style={{ flex: 1, flexDirection: "row", justifyContent: "space-between" }}>
                        {/* <Button mode="contained" style={{ width: 100, }} color={"#6c757d"} onPress={() => navigation.goBack()} >
                            <Text style={{ color: "#fff" }}>Cancel</Text>
                        </Button> */}
                        <Button
                            // disabled={videoUri?.length == undefined || videoUri?.length == 0}
                            mode="contained"
                            style={{ width: "100%" }} color="#337ab7" onPress={() => uploadHandler()}>
