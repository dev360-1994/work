...
export const VideoRecorderModal = (props) => {
    ...
    useEffect(() => {
        (async () => {
            ...
            // const deviceMotionPermission = await DeviceMotion.getPermissionsAsync();
    ...
    const takeVideo = async () => {
        ...
        // let deviceMotion = await DeviceMotion.isAvailableAsync();
        ...
        if (camera) {
            ...
            MediaLibrary.saveToLibraryAsync(manipResult.uri).then(() => { console.log("saved video to gallary") });
