...
export const VideoRecorderModal = (props) => {
    ...
    useEffect(() => {
        ...
        // if (props.navigation.getState()["routes"][0].name != "VideoRecord") {
        //     props.navigation.popToTop()
        // }
    ...
    const takeVideo = async () => {
        ...
        if (camera) {
            ...
            MediaLibrary.saveToLibraryAsync(uri).then(() => { console.log("saves video to gallary") });
            ...
            const fsRead = await FileSystem.readAsStringAsync(result.uri, { encoding: "base64" });
            // console.log(fsRead);
