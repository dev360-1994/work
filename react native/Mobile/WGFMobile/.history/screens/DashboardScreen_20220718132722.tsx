...
import { SafeAreaView, StyleSheet, TouchableOpacity, Platform, TouchableWithoutFeedback } from 'react-native';
...
export default function DashboardScreen({ navigation }: RootDrawerScreenProps<'Dashboard'>) {
    ...
    function toggleTheme() {
        ...
        updateUserContext({ ...userContext, token: sesInfo.token, tokenExpiryTime: sesInfo.tokenExpiryTime, isThemeDark: !sesInfo.isThemeDark, userInfo: sesInfo.userInfo });
    }

    useLayoutEffect(() => {
        navigation.setOptions({
            headerRight: () => { return <Text style={{ color: "white" }}>Click me</Text> }
        })
    }, [navigation]);
