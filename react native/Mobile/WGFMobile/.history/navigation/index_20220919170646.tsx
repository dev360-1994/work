...
import ContactLeagueTeamComponent from '../screens/Exchange/Component/ContactLeagueTeamComponent';
...
function ExchangeFilmTabs() {
  ...
  return (
    ...
    >
      ...
      {false &&
        <Tab.Screen name="ContactLeagueTeam" component={ContactLeagueTeamComponent} options={
          {
            tabBarIcon: ({ color }) => (
              <MaterialCommunityIcons name="history" size={22} color={color} />
            ),
