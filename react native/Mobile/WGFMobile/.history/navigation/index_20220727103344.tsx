...
function RootNavigator() {
  ...
  return (
    <Stack.Navigator>
      ...
      <Stack.Screen name="Root" component={DrawerNavigator} options={{ headerShown: true }} />
...
function ViewFilmTabs({ route }: { route: any }) {
  ...
  return (
    <PlaylistContext.Provider value={route.params}>
      <Tab.Navigator defaultScreenOptions={{ title: "view" }} screenOptions={
...
function RecordNested() {
  return (
    <Stack.Navigator screenOptions={{ headerShown: false, gestureEnabled: false }} >
      ...
      <Stack.Screen name='RecorderTemp' component={VideoRecorderModal} options={{ orientation: 'all' }} />
    </Stack.Navigator >
  );
}
