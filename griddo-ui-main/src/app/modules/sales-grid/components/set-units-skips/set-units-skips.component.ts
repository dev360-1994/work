...
@Component({
  selector: 'app-set-units-skips',
  templateUrl: './set-units-skips.component.html',
  styleUrls: ['./set-units-skips.component.scss']
})
export class SetUnitsSkipsComponent implements OnInit {
