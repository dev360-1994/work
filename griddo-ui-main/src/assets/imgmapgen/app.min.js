        ...
        d = {
            defaults: {
                ...
                input: {
                    ...
                    unitId: {
                        selector: 'select[name^="im["][name$="][unitId]"]',
                        fn: function () {
                            return a(this)
                                .attr("name")
                                .match(/im\[([\d]+)\]\[([^\)]+)\]/)
            ...
            init: function (e, f) {
                ...
                if (!e) {
                    (f = a.extend(!0, d.defaults, f)),
                        ...
                        h.html(
                            '<img class="image-mapper-img" /><svg class="image-mapper-svg" />'
                        );
                    ...
                    (i[0].onload = function () {
                        ...
                        d.addArea(e, "poly"),
                        "function" == typeof c[e].options.event.init &&
                        c[e].options.event.init.apply(g),
                        d.bindValues(e);
                }
            },
            update: function (b, e) {
                ...
                if (b >= 0) {
                    ...
                    "src" in e && h.attr("src", c[b].options.src),
                        ...
                        "function" == typeof c[b].options.event.update &&
                        c[b].options.event.update.apply(f);
                }
            },
            bindEvents: function (b) {
                ...
                a(window).on("resize", function () {
                    ...
                    f.on("click", function (a) {
                        ...
                        d.addPoint.apply(e, [b, f]),
                            "function" == typeof c[b].options.event.update &&
                            c[b].options.event.update.apply(e);
                    });
                var g, h;
                f.on("mousemove touchmove", function (f) {
                    ...
                    a.each(c[b].area[m].coords, function (a, b) {
                        var c = {
                            naturalX:
                                b.naturalX + Math.round((k.clientX - h.clientX) * l.ratioX),
                            naturalY:
                                b.naturalY + Math.round((k.clientY - h.clientY) * l.ratioY),
                        };
                        c.naturalX < 0 || c.naturalX >= n[0].naturalWidth
                            ? (p = !0)
                            : (c.naturalY < 0 || c.naturalY >= n[0].naturalHeight) &&
                            (p = !0),
                            (o[a] = c);
                    }),
                ...
                f.on("mousemove touchmove", function (a) {
                    ...
                    f.on("mouseup touchend", ".image-mapper-point", function (f) {
                        2 == f.button &&
                            (c[b].area[a(this).data("areaIndex")].coords.splice(
                                a(this).data("coordIndex"),
                                1
                            ),
                                d.refresh.apply(e, [b]));
                    }),
                ...
                a.each(c[b].options.input, function (d, e) {
                    ...
                    f.each(function () {
                        ...
                        "active" == d[1]
                            ? a(this).attr(
                                "checked",
                                d[0] == c[b].state.areaIndex ? "checked" : !1
                            )
                            : a(this).val(c[b].area[d[0]][d[1]]);
                    });
                });
            },
                ...
                a.each(c[b].options.input, function (f, g) {
                    ...
                    h.is("button")
                        ? a(document).on("click", g.selector, function () {
                            ...
                            "remove" == a[1] &&
                                (d.removeArea.apply(e, [b, a[0]]), d.refresh.apply(e, [b]));
                        })
                        : a(document).on("change", g.selector, function () {
                            var f = a(this),
                                ...
                                i = f.val();
                            "active" == h[1]
                                ? (a(g.selector).not(this).attr("checked", !1),
            ...
            getPosition: function (b, c, e) {
                ...
                return (
                    e
                        ? ((i.naturalX = Math.round(
                            (c.originalEvent.targetTouches[0].pageX - g.left) * h.ratioX
                        )),
                            (i.naturalY = Math.round(
                                (c.originalEvent.targetTouches[0].pageY - g.top) * h.ratioY
                            )))
                        : ((i.naturalX = Math.round(
                            (c.clientX + (window.scrollX || window.pageXOffset) - g.left) *
                            h.ratioX
                        )),
                            (i.naturalY = Math.round(
                                (c.clientY + (window.scrollY || window.pageYOffset) - g.top) *
                                h.ratioY
                            ))),
                    i
                );
            ...
            addArea: function (b, d) {
                1 == arguments.length && ((d = b), (b = a(this).data("imageMapper"))),
                    ...
                    "function" == typeof c[b].options.event.addArea &&
                    c[b].options.event.addArea.apply(this);
            },
            removeArea: function (a, b) {
                c[a].area.splice(b, 1),
                    c[a].state.areaLength--,
                    c[a].state.areaIndex >= c[a].state.areaLength
                        ? (c[a].state.areaIndex = 0)
                        : c[a].state.areaIndex == b && 0 !== b && c[a].state.areaIndex--,
                    0 === c[a].state.areaLength && d.addArea(a, "poly"),
                    "function" == typeof c[a].options.event.removeArea &&
                    c[a].options.event.removeArea.apply(this);
            },
            addCoord: function (a, b) {
                var d = c[a].state.areaIndex,
                    e = c[a].area[d].shape;
                (-1 == ["circle", "rect"].indexOf(e) ||
                    2 != c[a].area[d].coords.length) &&
                    c[a].area[d].coords.push(b);
            },
                                ...
                                : "circle" == h.shape
                                    ...
                                    (i ||
                                        ...
                                        i.attr(
                                            "r",
                                            Math.sqrt(
                                                Math.pow(j[2] - j[0], 2) + Math.pow(j[3] - j[1], 2)
                                            )
                                        ))
                                    : j.length >= 4 &&
                                    (i ||
                                        ...
                                        i
                                            .attr("x", Math.min(j[0], j[2]))
                                            .attr("y", Math.min(j[1], j[3])),
                                        i
                                            .attr("width", Math.abs(j[2] - j[0]))
                                            .attr("height", Math.abs(j[3] - j[1]))),
                            i &&
                            (i.attr("class", "image-mapper-shape"),
            ...
            asHTML: function (b) {
                ...
                a.each(c[b].area, function (d, e) {
                    ...
                    if (
                        ...
                        var h = Math.round(
                            Math.sqrt(Math.pow(f[2] - f[0], 2) + Math.pow(f[3] - f[1], 2))
                        );
                    ...
                    i.attr("target", c[b].area[d].target),
                        ...
                        i.attr("unitId", c[b].area[d].unitId),
        ...
        a(document).on("init", function () {
            ...
            a(document).on("click", "button.add-row", function (b) {
                ...
                a(document).on("update", "#image-map", function () {
                    ...
                    0 == c.options.src.length
                        ? a(".toggle-content").hide()
                        : a(".toggle-content").show();
                }),
                ...
                a(document).on("show.bs.modal", "#modal-code", function () {
                    ...
                    console.log('show.bs.modal', b);
                    a("#modal-code-result").text(b).css("whiteSpace", "pre");
                }),
                globalThis.showCode = function () {
                    var b = a("#image-map").imageMapper("asHTML");
                    return b;
                },
            ...
            var c = {
                success: function () {
                    ...
                    a("#image-mapper-continue", b).attr("disabled", !1),
                        ...
                        a(".input-group-addon > span", b).attr(
                            "class",
                ...
                a(document).on("change", "#image-mapper-file", function () {
                    ...
                    (d.onloadend = function (d) {
                        ...
                        c
                            ...
                            : a("#image-map").imageMapper("update", { src: "", file: "" });
                });
        });
    })(jQuery);
