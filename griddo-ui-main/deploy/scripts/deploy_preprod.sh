...
docker pull registry.gitlab.com/trutech/griddo/griddo.frontend:preprod

# Deploying the updated image
docker run -d --name griddo_qa_frontend -p 8080:80 registry.gitlab.com/trutech/griddo/griddo.frontend:preprod
